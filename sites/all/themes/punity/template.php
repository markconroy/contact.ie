<?php
// Punity by Adaptivethemes.com

/**
 * Override or insert variables into the html template.
 */
function punity_preprocess_html(&$vars) {
  global $theme_key;
 ...
 * Override or insert variables into the html template.
 */
function punity_process_html(&$vars) {
 ...
 */
function punity_preprocess_page(&$vars) {
 ...
 * Override or insert variables into the page template.
 */
function punity_process_page(&$vars) {
  // Hook into the color module.
  if (module_exists('color')) {
 ...
 */
function punity_preprocess_block(&$vars) {
 ...
 */
function punity_preprocess_node(&$vars) {
 ...
 */
function punity_preprocess_comment(&$vars) {
  // Add class if user picture exists
  if ($vars['picture']) {
 ...
 */
function punity_process_region(&$vars) {
