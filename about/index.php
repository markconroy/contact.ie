...
$title = "About Contact.ie";
$description = "Contact.ie, learn about the service and read FAQs";
?>

<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/head-n-header.php'; ?>
<main class="layout-contained padding">
  <h1>About Contact.ie</h1>
  <p>Contact.ie is a simple web app that lets you contact groups of politicians.</p>
  <p>You can contact <a href="/contact/parties">TDs by political party</a>, <a href="/contact/constituencies">TDs by constituency</a>, and <a href="/contact/councillors">town and county councillors</a>.</p>
