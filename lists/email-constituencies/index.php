...
/**
 * @file
 * This file presents a list of email addresses for TDs by constituency.
 */

$title = "List of Email Addresses for TDs by Constituency";
$description = "Find the email address of any/all TDs by constituency in Ireland";
?>
<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/head-n-header.php'; ?>
<main class="layout-contained padding">
  <h1>List of Email Addresses for TDs by Constituency</h1>

  <ul>
    <?php
    $file = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/assets/emails/constituencies.json');
    $items = json_decode($file, TRUE);
    foreach ($items as $item) {

      $email_addresses = $item['emails'];
      print $item['constituency_name'];
      print '<ul>';
